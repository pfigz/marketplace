...
<div class="container w-75">
    <form action="../../func/submit_order.php" id="submitOrder">   
        <div class="d-flex justify-content-end">
            <div class="card me-2">            
                <h3>Grand Total: $<span id="subtotal"><?= htmlspecialchars($subtotal) ?></span></h3>  
            </div>
        ...
        <div class="row" id="address">
            <div class="address">
                    ...
                    <input type="text" class="form-control mb-1" name="street" id="street" placeholder="House Number and Street">
                    <input type="text" class="form-control mb-1" name="state" id="state" placeholder="State">
                    <input type="text" class="form-control mb-2" name="zipcode" id="zipcode" placeholder="Zipcode">
            </div>  
        </div>
    </form>
        ...
        <table class="table align-middle">
            ...
            <?php foreach ($products as $p): ?>
                <tbody>
                    ...
                    <!--Quantity-->
                    <td>Qty: <?= $cart_qty[$p['productID']]; ?></td>
                </tbody>
            <?php endforeach; ?>
        </table>
    </div>
